...
- Keep `skills/agents-feedback/SKILL.md` in sync with the global install at `~/.config/opencode/skills/agents-feedback` (symlinked by default; re-link if you install via copy).
